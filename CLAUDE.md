...
## Project
Local Mac app. Python 3.11. FastAPI backend on localhost:8000. React frontend on localhost:5173. SQLite at ~/.job-tracker/applications.db. Gmail API read-only polling every 5 minutes.
